...
NDefines.NNavy.CAPITAL_RATIO_FOR_FULL_SCREENING_FOR_CARRIERS = 1
NDefines.NNavy.COMBAT_INITIAL_DURATION = 12	
NDefines.NNavy.ANTI_AIR_POW_ON_INCOMING_AIR_DAMAGE = 0.8 --- (0.2 -> 0.8)
NDefines.NNavy.SHIP_TO_FLEET_ANTI_AIR_RATIO = 0.1 --- (0.2 -> 0.05)
...
NDefines.NNavy.CONVOY_EFFICIENCY_MIN_VALUE = 0.25
NDefines.NNavy.CONVOY_EFFICIENCY_REGAIN_BASE_SPEED = 0.12
NDefines.NNavy.CONVOY_EFFICIENCY_REGAIN_AFTER_DAYS = 3
NDefines.NNavy.CONVOY_SINKING_SPILLOVER = 0.25
